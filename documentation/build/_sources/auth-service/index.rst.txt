...
.. code:: python
    ...
    class CognitoService:
        """
        CognitoService is a class to interact with Amazon Cognito for user authentication and management.
        ...
        Attributes:
            ...
            cognito (boto3.client): The Cognito client.
            jwks_cache (dict or None): Cache for JWKS (JSON Web Key Set).
            jwks_last_updated (int): Timestamp of when the JWKS cache was last updated.
            jwks_cache_duration (int): Duration in seconds to keep the JWKS cache.
            pool_name (str): The name of the user pool.
            pool_id (str): The ID of the user pool.
            client_name (str): The name of the client.
            client_id (str): The ID of the client.
            jwks_url_base (str): The base URL for JWKS endpoint.
        """
